...
function renderCompatibilityTab(){
  ...
  if(currentMode!=='couple'||!chartDataStoreA||!chartDataStoreB){
    container.innerHTML='<div class="yd-empty">Enter both partners\' details in Couple mode to see their Ashtakoot Guna Milan compatibility score.</div>';
    return;
  }
  ...
  container.innerHTML=`
    <div class="shadbala-intro">
      <span class="info-icon" id="ashtakoot-info-trigger">i</span>
      <span style="font-size:12.5px;color:#888">Tap the info icon for methodology &amp; simplification notes</span>
    </div>
    <div class="koota-hero-card">
      <div class="koota-hero-content">
        <div class="koota-hero-head">
          <div class="koota-hero-title">Total Ashtakoot Score</div>
...
function showTab(name){
  const tabs=['chart','positions','dashas','karakas','yogadosha','shadbala','avastha','navamsa','vargas','transit','argala','compatibility','reading'];
  ...
  if(name==='compatibility')renderCompatibilityTab();
}
