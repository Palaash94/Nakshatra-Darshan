...
function renderNakshatraKoota(){
  ...
  grid.innerHTML=`
    <div class="koota-hero-card">
      ...
      <div class="koota-hero-content">
        <div class="koota-hero-head">
          ...
          <div class="koota-hero-nak">${moonNakName} <span class="koota-hero-pada">Pada ${moonPada}</span></div>
    ...
    <div class="koota-card koota-card-secondary">
      <div class="koota-card-head">Ascendant Nakshatra — ${ascNak.name} <span class="koota-hero-pada">Pada ${ascNak.pada}</span></div>
...
function drawNavamsaChart(){
  ...
  svgContent+=drishtiLinesSvg(navHouseMap,polar,wedgeAngles,innerR*0.62);
...
function renderVargaDetail(key){
  ...
  `;
  drawGenericChartWheel('varga-svg',chart.houseMap,chart.ascSign,{showDrishti:true,onWedgeClick:'showVargaSegmentDetail'});
}
...
function showVargaSegmentDetail(house){
  ...
  panel.innerHTML=`
    <span class="seg-close" onclick="document.getElementById('varga-segment-detail').classList.add('hidden')">✕</span>
...
function showTab(name){
  const tabs=['chart','positions','dashas','karakas','yogadosha','shadbala','avastha','navamsa','vargas','reading'];
