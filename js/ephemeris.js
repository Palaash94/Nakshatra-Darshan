...
const TATVA_BG_PATHS={
  Fire:'<path d="M100 125 C70 125 55 105 55 85 C55 65 70 55 75 35 C78 50 88 50 88 35 C88 15 100 5 100 5 C95 25 105 35 105 50 C105 35 115 30 115 20 C125 35 125 55 120 70 C135 75 145 85 145 105 C145 118 130 125 100 125 Z" fill="currentColor"/>',
  Earth:'<path d="M30 110 L70 45 L110 110 Z" fill="none" stroke="currentColor" stroke-width="1.3"/><path d="M95 110 L135 50 L175 110 Z" fill="none" stroke="currentColor" stroke-width="1.3"/><line x1="15" y1="115" x2="185" y2="115" stroke="currentColor" stroke-width="1"/><line x1="48" y1="88" x2="78" y2="88" stroke="currentColor" stroke-width="0.8"/><line x1="113" y1="92" x2="143" y2="92" stroke="currentColor" stroke-width="0.8"/>',
  Air:'<path d="M20 50 C45 35 55 55 80 45 C105 35 110 55 140 48" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/><path d="M15 75 C40 58 52 80 78 68 C104 56 115 80 150 70" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/><path d="M25 100 C48 86 58 102 82 92 C106 82 112 100 145 92" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"/><circle cx="165" cy="40" r="2" fill="currentColor" opacity="0.7"/><circle cx="178" cy="65" r="1.4" fill="currentColor" opacity="0.5"/>',
  Water:'<path d="M100 30 C100 30 75 65 75 88 C75 102 86 113 100 113 C114 113 125 102 125 88 C125 65 100 30 100 30 Z" fill="none" stroke="currentColor" stroke-width="1.3"/><path d="M10 120 Q30 110 50 120 Q70 130 90 120" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" opacity="0.7"/><path d="M110 120 Q130 110 150 120 Q170 130 190 120" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" opacity="0.7"/><circle cx="45" cy="40" r="3" fill="none" stroke="currentColor" stroke-width="0.9" opacity="0.6"/><circle cx="160" cy="55" r="2" fill="none" stroke="currentColor" stroke-width="0.8" opacity="0.5"/>'
};
function tatvaBackgroundSvg(tatva){
  const paths=TATVA_BG_PATHS[tatva];
  if(!paths)return'';
  return`<svg class="tatva-bg" viewBox="0 0 200 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">${paths}</svg>`;
}
